...
export class ParkScene {
 ...
 frame(now){
  ...
  this.controls.update();if(this.mode==='park'&&this.camera.position.length()<PLANET_RADIUS+2)this.camera.position.setLength(PLANET_RADIUS+2);this.fireworks.faceCamera(this.camera);this.renderer.info.reset();this.composer.render();
 ...
 focusCastle(){this.tour=false;this.controls.minDistance=12;this.move(this.castleAnchor.localToWorld(new THREE.Vector3(18,20,35)).toArray(),this.castleAnchor.localToWorld(new THREE.Vector3(0,10.5,0)).toArray());}
