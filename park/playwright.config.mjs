...
export default defineConfig({
 testDir:'./tests/e2e',outputDir:'./test-results',timeout:120000,expect:{timeout:20000,toHaveScreenshot:{maxDiffPixelRatio:.006,threshold:.16,animations:'disabled',maskColor:'#f5f2eb'}},
