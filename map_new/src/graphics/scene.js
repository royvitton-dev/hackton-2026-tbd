...
export class TwinScene {
  ...
  showPlan(plan,model,sourceUrl){
    this.clear();this.materials=new Map();this.plan=plan;this.world.userData.mode='plan';this.world.userData.meshCount=model.meshes.length;
  ...
  setCars(visible){this.showCars=visible;this.world.traverse(o=>{if(o.userData.kind==='parked-car')o.visible=visible;});}
