...
export function neonadeuliSvg(){
  ...
  for(const [id,x,y] of [['P1',628,155],['P2',628,208],['P3',628,271]])lines.push(`<rect id="bay-${id}" data-kind="space" data-role="parking" x="${x-35}" y="${y-17}" width="70" height="34" fill="none" stroke="#809783"/>`);
