...
- 충전 습관은 핵심 지표 3개와 다음 행동 1개로 요약합니다. 점수 카드의 **왜 N점인지 보기**로 배터리 탭을 열면 쉬운 설명을 바로 볼 수 있습니다. 실제 반영 기록 → 잔량 구간/연결 대기의 항목별 계산 → 반올림 → 미반영 항목 순서이며, 논문 출처와 적용 한계는 아래쪽에 둡니다. 추가 가정은 기존 펼치기 버튼으로 확인합니다.
