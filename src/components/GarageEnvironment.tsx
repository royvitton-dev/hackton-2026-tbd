...
export function GarageEnvironment(){
  return <group>
    ...
    <mesh rotation={[-Math.PI/2,0,0]} position={[0,-.20,0]}><planeGeometry args={[80,80]}/><meshBasicMaterial color="#050c17" toneMapped={false}/></mesh>
    <mesh position={[0,-.12,0]} receiveShadow><cylinderGeometry args={[3.05,3.12,.16,128]}/><meshStandardMaterial color="#071320" metalness={.2} roughness={.8} envMapIntensity={.18}/></mesh>
