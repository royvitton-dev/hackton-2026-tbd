...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <footer className="site-footer"><span className="footer-brand"><Coffee size={16}/>BREW RACERS <b>작은 내기, 큰 즐거움.</b></span><span>MADE FOR YOUR COFFEE BREAK<span className="footer-dot">✳</span><button className="footer-guide" onClick={()=>setModal('guide')}>플레이 가이드</button><a href="/reports/index.html" target="_blank" rel="noreferrer">검증 리포트 ↗</a><span>© 2026 BREW RACERS</span></span></footer>
