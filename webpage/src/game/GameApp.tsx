...
export default function GameApp() {
  ...
  return <div className={`game-app ${full ? 'expanded-game' : ''}`}>
    <header className="topbar"><a className="brand" href="/" aria-label="데뷔온 홈"><span className="brand-symbol"><Sparkles size={23} fill="currentColor" /></span><span>DEBUT<span className="brand-colon">:</span>ON<small>꿈이 무대가 되는 순간</small></span></a>
