...
import { copyFile, mkdir, lstat, readFile, symlink } from 'node:fs/promises';
...
const excluded = /^(?:trading\/evidence\/|reports\/|codex_execution\.log$|prompt\.txt$|movie\/scripts\/__pycache__\/)/;
let count = 0;
